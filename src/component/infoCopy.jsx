...
import { Grid, makeStyles, Paper, Button, AppBar, Card } from '@material-ui/core'
...
export default function InfoCopy(props) {
    ...
    return <Paper className={classes.spriteVar}>
    <AppBar position="static" className={classes.toolHeader}>{title}</AppBar>
    <Grid className={cls(classes.commonPadding, classes.noWrap)} container spacing={3}>
        <Grid item xs={11}>
